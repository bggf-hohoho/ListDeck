      ...
      {vendors.map((vendor, i) => (
        ...
        >
           <div className="w-32 h-32 mb-4 rounded-full overflow-hidden shadow-xl border-4 border-white relative">
             <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover" style={imgStyle(vendor)} />
           </div>
        ...
        {vendors.map((vendor, i) => (
          ...
          >
            ...
            <div className="w-32 h-32 rounded-xl mb-3 overflow-hidden relative">
              <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" style={imgStyle(vendor)} />
            </div>
        ...
        {vendors.map((vendor, i) => (
          ...
          >
            <div className="w-full aspect-square bg-gray-100 mb-3 overflow-hidden relative">
                <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover filter contrast-110" style={imgStyle(vendor)} />
            </div>
          ...
          >
             <div className="relative p-2 border border-[#A16E5C] rounded-t-full border-b-0">
               <div className="w-32 h-40 rounded-t-[100px] rounded-b-lg overflow-hidden relative">
                 <img crossOrigin="anonymous" src={vendor.imageUrl} className="object-cover w-full h-full" style={imgStyle(vendor)} />
               </div>
             </div>
             ...
             <div className="border border-[#C5A582] p-4 w-full h-full flex flex-col items-center bg-[#1a1a1a]">
                <div className="w-full aspect-[3/4] overflow-hidden border border-[#C5A582] mb-3 p-1 relative">
                  <div className="w-full h-full overflow-hidden">
                    ...
                    <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover sepia-[.2]" style={imgStyle(vendor)} />
                  </div>
                </div>
        ...
        {vendors.map((vendor, i) => (
          ...
          >
            ...
            <div className="w-full aspect-square border-[3px] border-black mb-2 overflow-hidden relative">
              <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover filter contrast-125 saturate-150" style={imgStyle(vendor)} />
            </div>
         ...
         {vendors.map((vendor, i) => (
           ...
           >
             <div className="overflow-hidden rounded-[30%_70%_70%_30%/30%_30%_70%_70%] mb-4 w-full aspect-square relative">
               <img crossOrigin="anonymous" src={vendor.imageUrl} className="w-full h-full object-cover hover:scale-110 transition-transform duration-1000" style={imgStyle(vendor)} />
             </div>
